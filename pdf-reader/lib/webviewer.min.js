    ...
    return function(e) {
        ...
        o.WebViewer.prototype = {
            ...
            searchText: function(e, t) {
                var n = 0,
                    o = t;
                if ("string" == typeof o && (o = t.split(",")), void 0 !== o)
                    for (var i = 0; i < o.length; i++) "CaseSensitive" === o[i] ? n += 1 : "WholeWord" === o[i] ? n += 2 : "SearchUp" === o[i] ? n += 4 : "PageStop" === o[i] ? n += 8 : "ProvideQuads" === o[i] ? n += 16 : "AmbientString" === o[i] && (n += 32);
